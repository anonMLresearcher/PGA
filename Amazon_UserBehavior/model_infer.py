...
def get_neighbors_inf(src,part_q_feature_names,part_i_feature_names, i_nei_cnt=5, q_nei_cnt=5):
    ...
    src_i_nodes, _, _ = tf_euler.sample_neighbor(src, edge_types=['1', '3','991', '993'], count=i_nei_cnt)
    src_i_nodes_filled = tf_euler.get_sparse_feature(src_i_nodes, part_i_feature_names)
    src_q_nodes, _, _ = tf_euler.sample_neighbor(src, edge_types=['2','992'], count=q_nei_cnt)
...
def get_neighbor(x,q_part_features,i_part_features,c_part_features, q_nei_cnt=5,i_nei_cnt=5,c_nei_cnt=5 ):
    ...
    q_nodes, _, _ = tf_euler.sample_neighbor(x, edge_types=['2','5','992','995'], count=i_nei_cnt)
    i_nodes, _, _ = tf_euler.sample_neighbor(x, edge_types=['1', '3','7','991', '993','997'], count=i_nei_cnt)
    c_nodes, _, _ = tf_euler.sample_neighbor(x, edge_types=['46','66','9946' ], count=i_nei_cnt)
